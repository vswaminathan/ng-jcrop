...
(function(angular){
    ...
    angular.module('ngJcrop', [])
        ...
        '<div class="ng-jcrop">' +
        '    <div class="ng-jcrop-image-wrapper" id="ng-jcrop-image-wrapper">' +
        ...
        .directive('ngJcrop', ['ngJcropConfig','utilsService' ,function(ngJcropConfig,utilsService){

            return {
                restrict: 'EA',
                scope: { ngJcrop: '=', thumbnail: '=', selection: '=' ,templateUrl:'='},
                template: ngJcropConfig.template,
                controller: 'JcropController',
                link: function(scope,element) {
                    //utilsService.appendTemplate(scope,element,scope.templateUrl)
                }
            };
